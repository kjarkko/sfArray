...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libsfarray.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libsfarray.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libsfarray.a
	${AR} -rv ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libsfarray.a ${OBJECTFILES} 
	$(RANLIB) ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libsfarray.a

${OBJECTDIR}/sa_stringutils.o: sa_stringutils.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sa_stringutils.o sa_stringutils.c

${OBJECTDIR}/sa_suffixArray.o: sa_suffixArray.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sa_suffixArray.o sa_suffixArray.c

${OBJECTDIR}/util.o: util.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/util.o util.c
...
${TESTDIR}/tests/check_sa_stringutils.o: tests/check_sa_stringutils.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/check_sa_stringutils.o tests/check_sa_stringutils.c


${TESTDIR}/tests/check_sa_suffixArray.o: tests/check_sa_suffixArray.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/check_sa_suffixArray.o tests/check_sa_suffixArray.c


${TESTDIR}/tests/check_util.o: tests/check_util.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/check_util.o tests/check_util.c
...
${OBJECTDIR}/sa_stringutils_nomain.o: ${OBJECTDIR}/sa_stringutils.o sa_stringutils.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sa_stringutils_nomain.o sa_stringutils.c;\
	else  \
...
${OBJECTDIR}/sa_suffixArray_nomain.o: ${OBJECTDIR}/sa_suffixArray.o sa_suffixArray.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sa_suffixArray_nomain.o sa_suffixArray.c;\
	else  \
...
${OBJECTDIR}/util_nomain.o: ${OBJECTDIR}/util.o util.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/util_nomain.o util.c;\
	else  \
